...
async function cleanDevelopmentDatabase() {
  ...
  try {
    console.log('⚠️  WARNING: This will DROP ALL TABLES and DELETE ALL DATA in development database!')
...
async function dropTablesNeonSafe() {
  ...
  try {
    ...
    console.warn('⚠️  Could not drop all tables (this might be normal with Neon permissions):', error)
